...
const UsersPage = () => {
  ...
  return (
    <div className={`min-h-screen px-3 sm:px-4 md:px-6 lg:px-2 py-3 sm:py-4 md:py-25 transition-all duration-300 ease-in-out mt-14 md:mt-0 ${sidebarOpen ? "lg:ml-64 md:ml-64" : "lg:ml-53 md:ml-15"}`}>
